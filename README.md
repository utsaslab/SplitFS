...
The kernel patch for the implementation of relink() system call for linux v4.13 is [here](https://github.com/rohankadekodi/SplitFS/tree/master/kernel/relink_v4.13.patch)
